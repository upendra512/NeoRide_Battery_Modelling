    ...
    <section id="team" style={{
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 2rem' }}>
        ...
        <div style={{
          ...
          {/* Project Info */}
          <div style={{
            background: '#0d1b35', border: '1px solid rgba(0,212,255,0.2)',
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, justifyContent: 'center' }}>
              {tags.map(t => (
                <span key={t} style={{
                  ...
                  color: '#94a3b8', padding: '5px 13px', borderRadius: 20, fontSize: '0.78rem',
                }}>{t}</span>
              ))}
            </div>
          </div>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '1rem', fontWeight: 700, marginBottom: 20, color: '#00d4ff' }}>
            ...
            <a
              ...
              style={{
                ...
                borderRadius: 10, color: '#00d4ff', fontWeight: 700, fontSize: '0.9rem',
